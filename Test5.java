...
public class Test5 {
    ...
    public static void main(String[]args) {
        ...
        main_deck_wizard_1_t1.add("Balefrost"); 
        main_deck_wizard_1_t1.add("Balefrost");
        main_deck_wizard_1_t1.add("Wall Of Blades");
        main_deck_wizard_1_t1.add("Wall Of Blades"); 
        main_deck_wizard_1_t1.add("Wall Of Blades"); 
        ...
        main_deck_wizard_1_t1.add("Volcanic Shield");
        main_deck_wizard_1_t1.add("Volcanic Shield"); 
        main_deck_wizard_1_t1.add("Brilliant Light"); 
        main_deck_wizard_1_t1.add("Pacify on self"); 
        main_deck_wizard_1_t1.add("Pacify on self");
        main_deck_wizard_1_t1.add("Guiding Light"); 
        main_deck_wizard_1_t1.add("Guiding Light"); 
