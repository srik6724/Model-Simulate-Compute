...
public class EternalRobeStats extends Robe implements StatsInfo {
  ...
  public EternalRobeStats(String name, int health, int power_pip, int block, int resist, int accuracy, int pierce, int critical, int damage, int shadowRating, String school, Socket socket1, Socket socket2, Socket socket3)
  {
    super(name); 
    this.health = health; 
